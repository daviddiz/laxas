...
for linea_clientes in reader_clientes:
    ...
    cliente_account_ids = models.execute_kw(db, uid, password,'account.account', 'search', [[['code','=',"430000"],['company_id','=',3]]])
    ...
    cliente_ids = models.execute_kw(db, uid, password, 'res.partner', 'search', [[['name','=',linea_clientes[1]],['company_id','=',3]]])
    if cliente_ids:
